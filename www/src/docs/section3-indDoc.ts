...
export const section3DocItem: Item[] = [
    {
        ...
        <p>The results from the Annual School Progress Reports will be collated at the district level and shared with the department at a high level. No school-specific identifying information will be shared. Results will be used to help determine progress toward the objectives outlined in the 10-year Education Plan.&nbsp;</p>
    ...
    {
        id: "item2",
        name: "Self-Evaluation Process in Brief",
        selected: false,
        content: html`<p>Prior to authoring the Annual School Progress Report, schools will use the indicator document to self-assess.</p>
