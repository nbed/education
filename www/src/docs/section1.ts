...
export const section1: TabItem[] = [
    {
        ...
        <p>Please see <a href="#_Appendix_G:_Policy">Appendix G</a> for an elaboration of the obligations associated with improvement planning in New Brunswick schools. </p>`,
    },
    {
        id: "item2",
        name: "The Goals",
    ...
    },
    {
        ...
        <p><a href="http://www2.gnb.ca/content/dam/gnb/Departments/ed/pdf/K12/EveryoneAtTheirBest.pdf">http://www2.gnb.ca/content/dam/gnb/Departments/ed/pdf/K12/EveryoneAtTheirBest.pdf</a> &nbsp;</p>
        ...
        <p>(See <a href="#_Appendix_A:_10-year">Appendix A</a> for a graphic outlining the objectives of the 10-year Ed Plan.)&nbsp;</p>
    ...
    {
        id: "item4",
        name: "School Self-assessment Tool and Annual School Progress Report",
        selected: false,
